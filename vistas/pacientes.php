        ...
        <div class="white-box">
            ...
            <h3><span class="">
                    <button type="button" class="btn btn-info" id="add_button" onclick="limpiar()"
                            data-toggle="modal" data-target="#pacienteModal">
            ...
            <div class="table-responsive">
                <table id="paciente_data" class="table table-bordered table-striped" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th>Opciones</th>
                        <th>Identidad</th>
        ...
        <div class="modal fade" id="pacienteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form method="post" id="paciente_form" enctype="multipart/form-data" class="form-horizontal">
                        <div class="modal-body">
                            <section class="formulario-agregar_paciente">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                    <textarea class="form-control" rows="3" id="direccion" name="direccion"
