                                ...
                                <form class="">
                                    <div class="col-sm-8 col-md-8 col-lg-8">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <select style="visibility:hidden" name="ano1" id="ano1" class="form-control">
                                    ...
                                    <div class="col-md-4 col-lg-4 col-sm-4">
                                        <button type="button" class="btn btn-primary" id="btn_cita_mes"><i class="fa fa-search" aria-hidden="true"></i> Consultar</button>
                                    </div>
                                </form>
                            </div>
                            <!--Start row-->
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="white-box">
                                        ...
                                        <table id="cita_mes_data" class="display table" cellspacing="0" width="100%">
                                            <thead>
                                            <tr>
                                                <th>Ver Detalle</th>
                                                <th>Identidad</th>
